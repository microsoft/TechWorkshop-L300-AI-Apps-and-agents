...
Before deploying, you can optionally run the pre-flight quota check script to verify that your subscription has sufficient quota for all required resources (VM cores for App Service, Cosmos DB, Container Registry, AI Services) in the candidate regions:
