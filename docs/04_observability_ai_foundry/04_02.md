...
Next, login to your Azure Container Registry service by running the following command:

```bash
az acr login -n {YOUR_REGISTRY_NAME}.azurecr.io
```

Finaly, push the Docker image to your Azure Container Registry by running the following command:
