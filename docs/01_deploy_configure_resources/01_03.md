...
{: .note }
> If you get an error trying to create the container indicating that vector search is not enabled, close the New Container tab, wait a few more minutes and try again. It can take upwards of 15 minutes for this policy change to take effect, even if you see the policy's status as "On" in `az cli` or in the **Features** section of the **Settings** menu.
